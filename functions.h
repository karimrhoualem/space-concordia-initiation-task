...
//as a global variable so that multiple functions can read and write from/to board
...
//Function that receives Player 1's move and verifies if the move is valid. If valid, set move on the board.
//If invalid, prompt player for new move until a valid move is made. Then print updated board to screen.
void getMovePlayer1() {
...
//Function that receives Player 2's move and verifies if the move is valid. If valid, set move on the board.
//If invalid, prompt player for new move until a valid move is made. Then print updated board to screen.
void getMovePlayer2() {
...
//Function that verifies whether the position on the board is free or occupied.
int checkBoardAvailability(char position) {
...
//After every move that Player 1 makes, scan the board for all possible ways that Player 1 may have won the game.
//If Player 1 has won, return true.
bool checkWinnerPlayer1() {
...
//After every move that Player 2 makes, scan the board for all possible ways that Player 1 may have won the game.
//If Player 2 has won, return true.
bool checkWinnerPlayer2() {
...
//Final function that controls the operation of the game.
void playTicTacToe() {
